...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "input.gender.label": "Gender (for Hebrew grammar)",
    "input.gender.male": "Male",
    "input.gender.female": "Female",
    "input.gender.other": "Other",
    "input.leaderboard": "Show my result on the public leaderboard",
  ...
  he: {
    ...
    "input.gender.label": "מגדר (לדקדוק נכון)",
    "input.gender.male": "זכר",
    "input.gender.female": "נקבה",
    "input.gender.other": "אחר",
    "input.leaderboard": "הצג את התוצאה שלי בלידרבורד הציבורי",
