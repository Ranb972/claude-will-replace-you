    ...
    <div className="min-h-screen bg-noise bg-scanline bg-grid">
      <div className="max-w-[800px] mx-auto px-4 py-10 sm:py-14 space-y-6">
        ...
        <RevealSection className="space-y-4">
          ...
          <a href={`/api/og/${id}`} target="_blank" rel="noopener noreferrer"
            className="flex items-center justify-center w-full rounded-lg py-2.5 text-sm font-medium transition-all duration-200 hover:bg-white/5 cursor-pointer"
